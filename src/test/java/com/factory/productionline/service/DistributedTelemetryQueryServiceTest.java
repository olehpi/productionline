...
class DistributedTelemetryQueryServiceTest {
    ...
    void toResultIncludesStartAndFinishTransfers() {
        ...
        Map<Integer, Map<String, DistributedOperationEvent>> eventsByOperation = Map.of(
                0, Map.of(
                        "batch-60-0-1", new DistributedOperationEvent("route-60", 0, 1, 1, "batch-60", 0, 0d, 0d, 0d),
                        "batch-60-0-2", new DistributedOperationEvent("route-60", 0, 1, 2, "batch-60", 0, 0d, 0d, 0d)
                ),
                1, Map.of(
                        "batch-60-0-1", new DistributedOperationEvent("route-60", 1, 2, 1, "batch-60", 0, 2d, 3d, 5d),
                        "batch-60-0-2", new DistributedOperationEvent("route-60", 1, 2, 2, "batch-60", 0, 5d, 3d, 8d)
                ),
                2, Map.of(
                        "batch-60-0-1", new DistributedOperationEvent("route-60", 2, 3, 1, "batch-60", 0, 5d, 4d, 9d),
                        "batch-60-0-2", new DistributedOperationEvent("route-60", 2, 3, 2, "batch-60", 0, 9d, 4d, 13d)
                ),
                7, Map.of(
                        "batch-60-0-1", new DistributedOperationEvent("route-60", 7, 8, 1, "batch-60", 0, 21d, 2d, 23d),
                        "batch-60-0-2", new DistributedOperationEvent("route-60", 7, 8, 2, "batch-60", 0, 23d, 2d, 25d)
                )
        );
